...
Begin VB.Form FrmTrnLevelCurahHujan 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VSFlex8Ctl.VSFlexGrid fg 
            ...
            FormatString    =   $"FrmTrnCurahHujan.frx":0000
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin MyLASP.isButton cmdFind 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":00BB
            Style           =   5
            Caption         =   "&Find"
            IconSize        =   27
            CaptionAlign    =   2
         ...
         Begin MyLASP.isButton CmdEntry 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":0DB1
            Style           =   5
            Caption         =   "&Add"
            IconSize        =   27
            CaptionAlign    =   2
         ...
         Begin MyLASP.isButton CmdEdit 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":1457
            Style           =   5
            Caption         =   "&Edit"
            IconSize        =   27
            CaptionAlign    =   2
         ...
         Begin MyLASP.isButton cmdSave 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":1E4F
            Style           =   5
            Caption         =   "&Save"
            IconSize        =   27
            CaptionAlign    =   2
         ...
         Begin MyLASP.isButton cmdCancel 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":2B17
            Style           =   5
            Caption         =   "&Cancel"
            IconSize        =   27
            CaptionAlign    =   2
         ...
         Begin MyLASP.isButton CmdClose 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":382D
            Style           =   5
            Caption         =   "E&xit"
            IconSize        =   27
            CaptionAlign    =   2
         ...
         Begin MyLASP.isButton cmdDelete 
            ...
            _ExtentX        =   2566
            _ExtentY        =   873
            Icon            =   "FrmTrnCurahHujan.frx":43C1
            Style           =   5
            Caption         =   "&Delete"
            IconSize        =   27
            CaptionAlign    =   2
   ...
   End
End
Attribute VB_Name = "FrmTrnLevelCurahHujan"
...
Private Sub cmdFind_Click()
    FrmTrnLevelCurahHujanFind.Show
End Sub
...
Private Sub Setfg()
    fg.Rows = 1
    fg.AddItem "1" & vbTab & cboWilayah.Column(0) & vbTab & "CRH (mm)"
End Sub
...
Private Sub cmdDelete_Click()
    ...
    If MsgBox("Anda yakin mau menghapus data ini", vbYesNo) = vbYes Then
        cn.Execute "Delete  tblTrnLevelCurahHujanHdr where HeaderID= '" & Trim(txtHeaderID.Text) & "'"
        cn.Execute "Delete  tblTrnLevelCurahHujanDtl where HeaderID= '" & Trim(txtHeaderID.Text) & "'"
    Else
        cn.RollbackTrans
        Exit Sub
    End If
...
Function SaveDataHdr(cn As ADODB.Connection) As Integer
    ...
    cm.CommandText = "MyLASP..spLevelCurahHujanHdr"
    ...
    If cm.Parameters("@RETURN_VALUE") = 100 Then
        MsgBox "Rekapitulasi Level Curah Hujan pada Minggu ke - ( " & CInt(txtWeek.Text) & " - " & cboWilayah.Column(0) & " ) sudah ada, " & vbNewLine & _
               "Silahkan Klik ( Find ) untuk melihat record Level Curah Hujan."
        Call ErrMsg(Err)
        Me.MousePointer = vbDefault
        Set cm = Nothing
        Exit Function
...
Function SaveDataDtl(HeaderID As Integer, cn As ADODB.Connection, i As Integer) As Integer
    ...
    cm.ActiveConnection = cn
    cm.CommandType = adCmdStoredProc
    cm.CommandText = "MyLASP..spLevelCurahHujanDtl"
    ...
    cm.Parameters.Append cm.CreateParameter("@Satuan", adVarChar, adParamInput, 50, Trim(fg.TextMatrix(i, 2)))
...
Sub LoadHeaderLevelCurahHujan(HeaderID As String)
Dim rs As New ADODB.Recordset
Dim sql As String

sql = "Select * from MyLASP..vwRekapitulasiCurahHujan where HeaderID='" & HeaderID & "'"
...
Private Sub LoadDetailRekapitulasi(HeaderID As String)
    ...
    sql = "Select HeaderID,DetailID,Wilayah,Satuan,Nilai,Keterangan from vwRekapitulasiCurahHujan where HeaderID='" & HeaderID & "'order by DetailID Asc"
    rs.Open sql, ActiveCn, adOpenKeyset, adLockReadOnly
    Call HapusGrid(fg, 1)
    If rs.RecordCount > 0 Then
        rs.MoveFirst
        ...
        .Rows = 1
            ...
            fg.Subtotal flexSTAverage, -1, 3, "#,###.##", vbCyan, , , "Rata-Rata Curah Hujan"
        End With
    End If
End Sub
