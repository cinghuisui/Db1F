...
Begin VB.Form FrmMonLAKBulanan 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmMonLAKBulanan.frx":0000
      AccessibleName  =   ""
      ...
      Begin VB.Frame Frame1 
         BackColor       =   &H00C0FFC0&
         Caption         =   "Monitoring Level Air Kanal Bulanan"
         BeginProperty Font 
      ...
      Begin VSFlex8Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmMonLAKBulanan.frx":008E
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin MyLASP.isButton CmdClose 
         ...
         _ExtentX        =   1984
         _ExtentY        =   847
         Icon            =   "FrmMonLAKBulanan.frx":02B5
         Style           =   5
         Caption         =   "Clos&e"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdRefresh 
         ...
         _ExtentX        =   2302
         _ExtentY        =   847
         Icon            =   "FrmMonLAKBulanan.frx":0E49
         Style           =   5
         Caption         =   "&Refresh"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdExcel 
         ...
         _ExtentX        =   2011
         _ExtentY        =   847
         Icon            =   "FrmMonLAKBulanan.frx":1969
         Style           =   5
         Caption         =   "&Excel"
         IconSize        =   27
         CaptionAlign    =   2
   ...
   End
End
Attribute VB_Name = "FrmMonLAKBulanan"
...
Private Sub cmdRefresh_Click()
    ...
    Call LoadMonRekapitulasiLAKBulanan
    
    fg.Subtotal flexSTClear
    fg.SubtotalPosition = flexSTBelow
    For j = 3 To 14
        fg.Subtotal flexSTAverage, -1, j, "#,###", , , , "Rata-rata LAK PT.RSUP-PKB"
    Next j
    
'
End Sub

Private Sub LoadMonRekapitulasiLAKBulanan()
    Dim rs  As ADODB.Recordset
    Dim sql As String
    Dim i, j As Integer
    Dim DataSebelum As String
    Set rs = New ADODB.Recordset
    sql = "Select KodeWilayah,Wilayah,Bulan,Tahun,LAK,Round(AVG(Nilai),0) as Nilai from vwRekapitulasiAirKanal " & _
          "where Bulan between '" & Format(DTPicker1.Value, "MM") & "' and '" & Format(DTPicker2.Value, "MM") & "' and tahun='" & Format(DTPicker2.Value, "yyyy") & "' " & _
          "group by Bulan,Tahun,KodeWilayah,LAK,Wilayah Order by KodeWilayah Asc"
                ...
                End If
                    ...
                    End If
                        .TextMatrix(.Rows - 1, 15) = GetValue("Select Round(AVG(Nilai),0) as GetValue " & _
                                                    " From fnRekapitulasiLAKBulanan('" & rs!KodeWilayah & "','" & Format(DTPicker1.Value, "MM") & "','" & Format(DTPicker2.Value, "MM") & "','" & Format(DTPicker2.Value, "yyyy") & "') ")
