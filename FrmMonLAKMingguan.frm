...
Begin VB.Form FrmMonLAKMingguan 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmMonLAKMingguan.frx":0000
      AccessibleName  =   ""
      ...
      Begin VB.Frame Frame1 
         BackColor       =   &H00C0FFC0&
         Caption         =   "Monitoring Level Air Kanal Mingguan"
         BeginProperty Font 
      ...
      Begin VSFlex8Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmMonLAKMingguan.frx":0089
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin MyLASP.isButton CmdClose 
         ...
         _ExtentX        =   1958
         _ExtentY        =   820
         Icon            =   "FrmMonLAKMingguan.frx":03E5
         Style           =   5
         Caption         =   "Clos&e"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdRefresh 
         ...
         _ExtentX        =   2328
         _ExtentY        =   820
         Icon            =   "FrmMonLAKMingguan.frx":0F79
         Style           =   5
         Caption         =   "&Refresh"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdExcel 
         ...
         _ExtentX        =   1984
         _ExtentY        =   820
         Icon            =   "FrmMonLAKMingguan.frx":1A99
         Style           =   5
         Caption         =   "&Excel"
         IconSize        =   27
         CaptionAlign    =   2
   ...
   End
End
Attribute VB_Name = "FrmMonLAKMingguan"
...
Private Sub cmdRefresh_Click()
    ...
    Call LoadRekapitulasiLAKMingguan
...
Private Sub LoadRekapitulasiLAKMingguan()
    ...
    sql = "Select HeaderID,Transdate,Weekday,KodeWilayah,Wilayah,LAK,Nilai from vwRekapitulasiAirKanal " & _
