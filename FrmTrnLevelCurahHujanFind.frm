...
Begin VB.Form FrmTrnLevelCurahHujanFind 
   Caption         =   "Level Curah Hujan Find"
   ClientHeight    =   8415
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   14535
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmTrnLevelCurahHujanFind.frx":0000
      AccessibleName  =   ""
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MyLASP.isButton cmdRefresh 
            ...
            _ExtentX        =   2302
            _ExtentY        =   873
            Icon            =   "FrmTrnLevelCurahHujanFind.frx":005E
            Style           =   5
            Caption         =   "&Refresh"
            IconSize        =   27
            CaptionAlign    =   2
      ...
      Begin VSFlex8Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmTrnLevelCurahHujanFind.frx":0B7E
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid fg2 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"FrmTrnLevelCurahHujanFind.frx":0C37
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "FrmTrnLevelCurahHujanFind"
   ...
   Select Case Col
        Case 1
             If fg2.Row <> 0 And fg2.TextMatrix(fg2.Row, 1) <> "" Then
                Call FrmTrnLevelCurahHujan.LoadHeaderLevelCurahHujan(fg.TextMatrix(fg.Row, 1))
                Unload Me
            End If
...
Private Sub DTPicker2_Change()
    'LoadLevelCurahHujanHdr
End Sub
Private Sub LoadLevelCurahHujanHdr()
    ...
    If cboWilayah.Text = "" Then
        sql = "select HeaderID,KodeWilayah,Wilayah,Transdate,Weekday from vwRekapitulasiCurahHujan Where KodeWilayah like '" & IIf(MDIProject.GroupUser = "ADM WILAYAH", MDIProject.Wilayah, "") & "%' " & _
              IIf(sql = "", "", " AND " & sql) & _
              "order by KodeWilayah,Weekday Asc"
    Else
        sql = "select HeaderID,KodeWilayah,Wilayah,Transdate,Weekday from vwRekapitulasiCurahHujan where KodeWilayah like '" & cboWilayah.Column(1) & "' " & _
              IIf(sql = "", "", " AND " & sql) & _
              "order by KodeWilayah,Weekday Asc"
    End If
...
Private Sub fg_Click()
    If fg.Row <> 0 And fg.TextMatrix(fg.Row, 1) <> "" Then
        Call LoadDetailRekapitulasiCRH(fg.TextMatrix(fg.Row, 1))
    End If
End Sub

Private Sub LoadDetailRekapitulasiCRH(HeaderID As String)
    Dim rs  As ADODB.Recordset
    Dim sql As String
    Dim I As Integer
    Dim j As Integer
    ...
    If rs.RecordCount > 0 Then
        ...
        .Rows = 1
            ...
            fg2.Subtotal flexSTAverage, -1, 4, "#,###.##", vbCyan, , , "Rata-Rata"
        End With
    End If
End Sub
