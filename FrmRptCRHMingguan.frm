...
Begin VB.Form FrmRptCRHMingguan 
   Caption         =   "Laporan Curah Hujan Mingguan"
   ClientHeight    =   7350
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   11160
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmRptCRHMingguan.frx":0000
      AccessibleName  =   ""
      ...
      Begin DDActiveReportsViewer2Ctl.ARViewer2 ARViewer2 
         ...
         _ExtentX        =   19368
         _ExtentY        =   9155
         SectionData     =   "FrmRptCRHMingguan.frx":0098
      End
      Begin MyLASP.isButton CmdClose 
         ...
         _ExtentX        =   2117
         _ExtentY        =   873
         Icon            =   "FrmRptCRHMingguan.frx":00D4
         Style           =   5
         Caption         =   "Clos&e"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdRefresh 
         ...
         _ExtentX        =   2302
         _ExtentY        =   873
         Icon            =   "FrmRptCRHMingguan.frx":0C68
         Style           =   5
         Caption         =   "&Refresh"
         IconSize        =   27
         CaptionAlign    =   2
   ...
   End
End
Attribute VB_Name = "FrmRptCRHMingguan"
...
Private Sub Form_Load()
    ...
    If FormKontrol = "ALL" Then
        Me.Caption = "Laporan CRH Bulanan"
    Else
        Me.Caption = "Laporan CRH Mingguan"
    End If
End Sub
...
Private Sub cmdRefresh_Click()
    ...
    If FormKontrol = "ALL" Then
        ...
        Set ARViewer2.ReportSource = New rptCRHBulanan
        Me.MousePointer = vbDefault
        Exit Sub
    Else
        Me.MousePointer = vbHourglass
        Set ARViewer2.ReportSource = New rptCRHMingguan
        Me.MousePointer = vbDefault
        Exit Sub
    End If
