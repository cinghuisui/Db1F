...
Begin VB.Form FrmMonLevelAirSumurPantauBulanan 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmMonLevelAirSumurPantauBulanan.frx":0000
      AccessibleName  =   ""
      ...
      Begin VB.Frame Frame1 
         BackColor       =   &H00C0FFC0&
         Caption         =   "Monitoring Level Air Sumur Pantau Bulanan"
         BeginProperty Font 
      ...
      Begin VSFlex8Ctl.VSFlexGrid fg 
         ...
         FormatString    =   $"FrmMonLevelAirSumurPantauBulanan.frx":0088
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin MyLASP.isButton CmdClose 
         ...
         _ExtentX        =   1984
         _ExtentY        =   873
         Icon            =   "FrmMonLevelAirSumurPantauBulanan.frx":02AF
         Style           =   5
         Caption         =   "Clos&e"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdRefresh 
         ...
         _ExtentX        =   2302
         _ExtentY        =   873
         Icon            =   "FrmMonLevelAirSumurPantauBulanan.frx":0E43
         Style           =   5
         Caption         =   "&Refresh"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdExcel 
         ...
         _ExtentX        =   1984
         _ExtentY        =   873
         Icon            =   "FrmMonLevelAirSumurPantauBulanan.frx":1963
         Style           =   5
         Caption         =   "&Excel"
         IconSize        =   27
         CaptionAlign    =   2
   ...
   End
End
Attribute VB_Name = "FrmMonLevelAirSumurPantauBulanan"
...
Private Sub cmdRefresh_Click()
    ...
    Call LoadMonRekapitulasiLASPBulanan
    fg.Subtotal flexSTClear
    fg.SubtotalPosition = flexSTBelow

    For j = 3 To 14
        fg.Subtotal flexSTAverage, -1, j, "#,###", , , , "Rata-rata LASP PT.RSUP-PKB"
    Next j
...
Private Sub LoadMonRekapitulasiLASPBulanan()
    Dim s  As String
    ...
    sql = "Select KodeWilayah,Wilayah,Bulan,Tahun,Round(AVG(nilai),0) as Nilai from vwRekapitulasiSumurPantau " & _
          "where Bulan between '" & Format(DTPicker1.Value, "MM") & "' and '" & Format(DTPicker2.Value, "MM") & "' and tahun='" & Format(DTPicker2.Value, "yyyy") & "' " & _
          "group by Bulan,Tahun,KodeWilayah,Wilayah Order by KodeWilayah Asc"
        ...
        .Rows = 2
            Do Until rs.EOF
                ...
                End If
                    ...
                    End If
                        .TextMatrix(.Rows - 1, 15) = GetValue("Select Round(AVG(nilai2),0) as GetValue " & _
                                                    " From fnRekapitulasiLASPBulanan ('" & rs!KodeWilayah & "','" & Format(DTPicker1.Value, "MM") & "','" & Format(DTPicker2.Value, "MM") & "','" & Format(DTPicker2.Value, "yyyy") & "') ")
