...
Begin VB.Form FrmRptGrafikCurahHujan 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"FrmRptGrafikCurahHujan.frx":0000
      AccessibleName  =   ""
      ...
      Begin DDActiveReportsViewer2Ctl.ARViewer2 ARViewer2 
         ...
         _ExtentX        =   23310
         _ExtentY        =   11271
         SectionData     =   "FrmRptGrafikCurahHujan.frx":008F
      End
      Begin MyLASP.isButton CmdClose 
         ...
         _ExtentX        =   1958
         _ExtentY        =   900
         Icon            =   "FrmRptGrafikCurahHujan.frx":00CB
         Style           =   5
         Caption         =   "Clos&e"
         IconSize        =   27
         CaptionAlign    =   2
      ...
      Begin MyLASP.isButton cmdRefresh 
         ...
         _ExtentX        =   2275
         _ExtentY        =   900
         Icon            =   "FrmRptGrafikCurahHujan.frx":0C5F
         Style           =   5
         Caption         =   "&Refresh"
         IconSize        =   27
         CaptionAlign    =   2
   ...
   End
End
Attribute VB_Name = "FrmRptGrafikCurahHujan"
...
Private Sub Form_Load()
    ...
    If FormKontrol = "ALL" Then
        Me.Caption = "Laporan Grafik Curah Hujan"
        Frame1.Caption = "Laporan Grafik Curah Hujan"
        cboWilayah.Visible = False
        lblWilayah.Visible = False
    Else
        Me.Caption = "Laporan Grafik Curah Hujan PerWil"
        Frame1.Caption = "Laporan Grafik Curah Hujan PerWilayah"
...
Private Sub cmdRefresh_Click()
    ...
    If FormKontrol = "ALL" Then
        Me.MousePointer = vbHourglass
           Set ARViewer2.ReportSource = New rptCRHGrafikMingguan
